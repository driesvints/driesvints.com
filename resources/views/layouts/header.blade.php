<div id="header" class="bg-black relative text-lg">
    <div class="{{ isset($small) ? '' : 'max-w-8xl m-auto' }} bg-cover bg-no-repeat" style="background-image: url('/images/{{ isset($small) ? 'header-black' : 'header' }}.jpg'); background-position: {{ isset($small) ? 'top right' : '0 25%' }}">
