...
-------
A lot of people are submitting issues these days to [the Laravel 4 Framework repository](https://github.com/laravel/framework). Sometimes there’s a pull request with code attached to fix a certain bug or to improve the framework by adding new functionality. I’ll go over each step to submit a successful issue or pull request to the Laravel 4 repo and help you contribute to the framework.<!--more-->
